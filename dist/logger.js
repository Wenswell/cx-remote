...
function write(level, message, meta, flags) {
...
function formatConsoleLine(ts, level, message, meta, flags) {
...
function formatConsoleMeta(meta, flags) {
    ...
    for (const key of preferred) {
        if (meta[key] !== undefined)
            pairs.push(asPair(shortKey(key), meta[key]));
    }
